...
import { startFetchMealsBySearch } from '../../Action/MealsActions';
...
const SearchForm = () => {
  ...
  return (
    <form className='search-form flex align-center' onSubmit={(e) => handleSearchResult(e)}>
      <input type = "text" className='form-control-input text-dark-gray fs-15' placeholder='Search' onChange={(e) => handleSearchTerm(e)} />
